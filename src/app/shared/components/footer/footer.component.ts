    ...
    <footer class="app-footer">
      ...
      <div class="footer-top">
        ...
        <div class="footer-brand">
          ...
          <div>
            <div class="footer-brand-name">Garras de Águia</div>
        ...
        <div class="footer-section">
          ...
          <div class="footer-links">
            ...
            <a class="footer-link"
               href="https://wa.me/5511964386463"
            ...
            <a class="footer-link"
               href="https://www.instagram.com/dbvgarrasdeaguia/"
               target="_blank" rel="noopener"
            ...
            <!-- <a class="footer-link"
               href="https://facebook.com/garradeaguia"
               target="_blank" rel="noopener"
